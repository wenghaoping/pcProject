...
<script type="text/ecmascript-6">
  import upload from '../../components/uploadHeadPic.vue'
  export default {
    data () {
      return {
        baseInfo: true,
